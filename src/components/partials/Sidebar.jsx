...
import { PiSignOutBold, PiStudent, PiStudentFill } from "react-icons/pi";
...
const Sidebar = () => {
    const navLinks = [
        ...
        },
        {
            ...
            link: "/courses",
            icon: (
                <BsMortarboardFill className="text-xl group-hover:text-primary" />
            ),
        },
        {
            name: "Reviews",
        ...
        },
        {
            ...
            link: "/about",
            icon: (
                <BsInfoCircleFill className="text-xl group-hover:text-primary" />
            ),
        },
        {
            name: "Team",
        ...
        },
        {
            ...
            link: "/students",
            icon: (
                <PiStudentFill className="text-xl group-hover:text-primary" />
            ),
        },
        {
            name: "Testimonials",
            link: "/testimonials",
            icon: (
                <BsChatLeftDotsFill className="text-xl group-hover:text-primary" />
            ),
        },
        {
            name: "Inbox",
